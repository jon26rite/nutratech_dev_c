...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="col-lg-12">
            <div>
                <ul class="my-header-ul">
                    <li> <h3><i class="fa fa-cogs fa-fw"></i>Motor Pool Masterfiles  </h3>
                    </li>
                    <li> <h3><span class="sub-header"><asp:Label ID="lblMenu" runat="server" Text=""></asp:Label></span></h3>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <asp:MultiView ID="MultiView2" runat="server">
        <asp:View ID="ViewAccessory" runat="server">                     
            ...
            <script src="javascript/motorpool/masterfileAccessory.js"></script>
         </asp:View>
        ...
        <asp:View ID="ViewAccessoryGroup" runat="server">                     
            ...
            <script src="javascript/motorpool/masterfileAccessoryGroup.js"></script>
        </asp:View>
        ...
        <asp:View ID="ViewVehicleAccessory" runat="server">
            ...
            <script src="javascript/motorpool/masterfileVehicleAccessory.js"></script>
        </asp:View>
    
        <asp:View ID="ViewServiceType" runat="server">                     
            <div class="row xrow">
                <div class="col-sm-4">
                    ...
                    <div class="row xrow">
                        <div class="input-group input-group-xs">
                            <span class="input-group-addon span-addon" style="color: #286090; text-align: left;">Code : </span>
                            <input type="text" id="st_code" class="form-control" value="" placeholder="Code" disabled autofocus required maxlength="10" />
                        </div>
                    </div>
                    <div class="row xrow">
                        <div class="input-group input-group-xs">
                            <span class="input-group-addon span-addon" style="color: #286090; text-align: left;">Description :* </span>
                            <input type="text" id="st_description" class="form-control" value="" placeholder="Description" disabled autofocus required maxlength="255" />
                        </div>
                    </div>                    
                </div>
            </div> 
             ...
             <div class="row xrow">
                <table id="T_Service_Type" class=" table-bordered table-hover item_inventory table-font dataTables_scrollBody" style="height: 20px; overflow-y: auto;">
                    <thead class="GridHeader">
                    </thead>
                </table>
            </div>
            <script src="javascript/motorpool/masterfileServiceType.js"></script>
        </asp:View>
