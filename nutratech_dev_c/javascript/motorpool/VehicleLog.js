...
var initTable = function () {
    ...
    vTable = $('#T_VehicleLog').dataTable({
        ...
        "bDestroy": true,
        "bServerSide": true,
        "sAjaxSource": "masterfile.asmx/getVehicleLogsDT",
        // "aaData": tblData,
        "fnServerData": function (sSource, aoData, fnCallback) {
            aoData.push({ "name": "roleId", "value": "admin" });
            aoData.push({ "name": "searchValue", "value": search });
            aoData.push({ "name": "vehicle_plate_no", "value": vehicle_plate_no });
            $.ajax({
                "dataType": 'json',
        ...
        "aoColumns": [
            { "mDataProp": "vehicle_plate_no", "sTitle": "Plate No.", "bSearchable": true },
            { "mDataProp": "odometer" , "sTitle": "Odometer" },
            { "mDataProp": "last_fuel_price", "sTitle": "Last Fuel Price" },
            { "mDataProp": "total_gas", "sTitle": "Total Gas" },
            { "mDataProp": "total_cost", "sTitle": "Total Cost" },
            { "mDataProp": "date", "sTitle": "Date" },
            { "mDataProp": "full_tank", "sTitle": "Full Tank" },
            { "mDataProp": "result", "sTitle": "Result (KM/L)" },
